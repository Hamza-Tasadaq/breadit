...
export async function POST(req: Request) {
    try {
        ...
        const { subredditId } = SubreditSubscriptionValidator.parse(body);
        ...
        return new Response("Couldn't unSubscribe from this subredit. Please try again latter.", { status: 500 });
    }
}